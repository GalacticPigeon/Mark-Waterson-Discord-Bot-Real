...
status = cycle(['Just Vibin', 'with your mom lmao', 'Stuff', 'Currently facing east',])
...
async def version(ctx):
    await ctx.send('Mark 1.14 has (succ)essfully launched babyyyy')
...
async def _8ball(ctx, *, question):
    ...
    if 'will you listen' in question:
...
client.run('Njk3MTEyMjE5MTYyMjQ3MTc5.XoyiWA.H63wnaYpk9vb3KqCsUydALH0XMQ')
